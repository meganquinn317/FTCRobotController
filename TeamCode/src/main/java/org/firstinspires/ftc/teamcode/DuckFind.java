...
@Autonomous(name = "DuckFind", group = "")

public class DuckFind extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (tfod != null) {
            ...
            // The TensorFlow software will scale the input im ages from the camera to a lower resolution.
                ...
                if (tfod != null) {
                    ...
                    if (updatedRecognitions != null) {
                        ...
                        for (Recognition recognition : updatedRecognitions) {
                            ...
                            telemetry.addData("CenterH",(recognition.getLeft()+ recognition.getRight())/2.0f);
                            i++;
                        }
                        telemetry.update();
